...
## buy sell at the next_close version, use 4MA, 4MV and KD (4MA begin up and 4MV begin up and K>D && 4MA begin down and 4MV begin up and K<D)
...
save.image("strategyTrading_4EMA_4MV_KD_result.Rdata")
